...
CAPTURE_WIDTH = 700
CAPTURE_HEIGHT = 400
DELAY_SECONDS = 0.4  # Delay between scans
LOG_FILE = "tooltip_ocr_log.txt"
DEBUG_IMAGE = True  # Set to True to save debug box images
...
def capture_area_around_cursor():
    ...
    # print(f"[Debug] Captured image size: {img.size}, mode: {img.mode}")
    # if DEBUG_IMAGE:
    ...
    width = min(CAPTURE_WIDTH, screen_w - left)
    height = min(CAPTURE_HEIGHT, screen_h - top)
