        ...
        if key.startswith("markers"):
            ...
            for s in marker_list:
                stores.append({
                    ...
                    "is_delivery_capable": s.get("is_delivery_capable"),
                    "is_dropship_capable": s.get("is_dropship_capable"),
                    "has_inventory_data": s.get("has_inventory_data"),
    ...
    for lat in frange(LAT_MIN, LAT_MAX, LAT_STEP):
        for lng in frange(LNG_MIN, LNG_MAX, LNG_STEP):
            ...
            try:
                ...
                # #[debug] save tile data to file
                # with open("tile_data.txt", "a") as f:
                #     f.write(f"{tile_data}\n")
...
OUTPUT_FILE = "store_data_hoka.xlsx"
FAILED_TILES_LOG = "failed_tiles_hoka.txt"
